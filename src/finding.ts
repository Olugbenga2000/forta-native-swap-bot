...
export const createMetadata = (
  ...
  const swapTokensAddressesAndAmount = addrRecord.tokenSwapData.reduce(
    (acc1, data) => [
      ...acc1,
      ...data.tokensSwapped.reduce((acc, transferData) => [...acc, transferData], initialValue),
    ],
    initialValue
  );
  return {
